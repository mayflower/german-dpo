...
# Einlesen der JSONL-Datei
jsonl_filename = sys.argv[1]  # Pfad zur JSONL-Datei
...
# Speichern in einer neuen JSON-Datei
new_json_filename = sys.argv[2]
...
print(f"Übersetzung abgeschlossen. Ergebnisse gespeichert in {new_json_filename}")
